...
@testset "CoolPropExtensions.jl" begin
    ...
    c_p = CoolPropExtensions.keyed_output(water, constant_pressure_specific_heat)
    ...
    pd = CoolPropExtensions.first_partial_deriv(water, mass_density, pressure, temperature)
    @test pd≈4.489626212601196e-7
    work = CoolPropExtensions.isothermalwork(WorkingFluid("HEOS","Water"),300.0, 10atm, 100atm, rtol=1e-8)
